...
excel_file_path = "./Dep-95.xls"
df = pd.read_excel(excel_file_path)

# Adresse e-mail et mot de passe de l'expéditeur
sender_email = "luqmansaidmohamedharibou@gmail.com"
sender_password = "gjovvstdkdxteabx"
...
cv_file_path = "./CV Luqman SAID MOHAMED HARIBOU 2023.pdf"
...
"""for index, row in df.iterrows():
    email = row['Courriel']
    if pd.notna(email):
        send_email_with_attachment(email, "[CANDIDATURE] - Alternance Informatique", message_content, cv_file_path)
    else:
        print("L'email est vide, ne peut pas envoyer l'e-mail.")"""

send_email_with_attachment("luqmansmh.pro@gmail.com", "[CANDIDATURE] - Alternance Informatique", message_content, cv_file_path)